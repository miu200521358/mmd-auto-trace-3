...
@REM set PROCESS=posetriplet,mix
set PROCESS=posetriplet,mix,motion
set LOGMODE=0
set LANG=ja
...
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\04\yoiyoi\yoiyoi_mp4_20221005_073259" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\about\about_mp4_20221005_023105" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\check\check_mp4_20221005_031458" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\goast\goast_mp4_20221005_035446" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\green\green_mp4_20221005_044244" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\ikki\ikki_mp4_20221005_053414" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\ousama\ousama_mp4_20221005_062142" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\roki\roki_20191202_100912" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\05\teo\teo_mp4_20221005_065551" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%

set PROCESS=mediapipe,posetriplet,mix,motion
...
python executor.py --img-dir "E:\MMD\MikuMikuDance_v926x64\Work\201805_auto\06\taiyou\taiyou_mp4_20221005_014006" --process %PROCESS% %HAND% --verbose 20 --log-mode %LOGMODE% --lang %LANG%
